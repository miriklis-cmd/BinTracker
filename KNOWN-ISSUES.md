...
Current release: **v0.4.0-alpha.24.2.25**
...
- v0.4.0-alpha.24.2.25: Remaining Batch Entry Esc/Clear edit-state race and recovery-button alignment require focused operator smoke-test; current larger icon trial remains pending final approval.
