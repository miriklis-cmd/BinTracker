...
- [ ] `Build-BinTracker.bat` reports v0.4.0-alpha.24.2.25 and the actually resolved installed SDK.
...
- [ ] `Package-BinTracker.ps1` produces ZIP filename/root folder/Version/InformationalVersion all exactly `0.4.0-alpha.24.2.25`.
...
- [ ] Login, Main, breakout reports and dialogs use BinTracker icon; taskbar is branded before login. For v0.4.0-alpha.24.2.25, visually compare the newly supplied hybrid icon trial and either approve it or request reversion.
