...
- The dormant IMP-06 appender supplies only the caller-owned DbContext/transaction persistence primitive for that future primary event; it performs no save/commit, leaves the independent AuditService unchanged and is not production operation/audit wiring.
