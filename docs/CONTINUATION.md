...
**Purpose:** Give a new session enough verified state, frozen movement-lineage semantics, dependency ordering and acceptance limits to continue from the reviewed and committed Import replacement-comparison checkpoint without relying on prior chat history or mistaking dormant preparation for runtime activation.
