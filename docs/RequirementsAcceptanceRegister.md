...
User-approved R1–R4 are frozen verbatim in Architecture; R5–R7 refine their validation and scope. No new permanent ID is needed: R1 extends the PLANNED-V1 BT-CORR-026/029/031 mapping and builds on implemented command identity under BT-ARCH-013; R2 extends BT-ARCH-016 and BT-CORR-022/024/027; R3 extends BT-AUD-009/010/015/016 and BT-HIST-008; R4/R5/R6 extend BT-ARCH-017, BT-CORR-030/032 and BT-OPS-011/012. R7 applies existing BT-CORR-029/033 snapshot evidence. Existing statuses are unchanged. BT-ARCH-013 is confined to implemented command identity, duplicate prevention and changed-payload conflict; pending Single response receipt/replay semantics belong to BT-CORR-026 and this R1 decision record, not its IMPLEMENTED-STATIC row. This text-only clarification removes the prior overstatement of exact Single numeric replay without demoting implemented behavior.
...
| BT-CORR-026 | v1 | PLANNED-V1 | ClientOperationId/fingerprint makes retries exact: same ID/same intent returns the original committed result even after later generations, changed reuse fails, rollback leaves no reservation/artifacts and lost-response retry never duplicates generation/ledger/audit. Activated17 Single response uses the immutable typed R1 receipt; identical migrated/pre-receipt Single retry lacking truthful historical response evidence has the explicitly approved controlled unavailable-result exception without duplicate or lineage rewrite. | USER-REQUEST,CURRENT-DOC |
